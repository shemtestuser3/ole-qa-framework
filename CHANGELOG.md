...
* Main Testing Framework Class
    * Renamed, OLE_QAF::OLE_Framework -> OLE_QAF::Framework
...
* Now using Version Gem to maintain OLE_QAF::VERSION constant
...
* API Change
    * All classes now enclosed within OLE_QAF namespace
* lib/module
    * QAF_Helpers
